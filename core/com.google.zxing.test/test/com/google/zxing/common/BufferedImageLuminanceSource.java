...
public final class BufferedImageLuminanceSource extends LuminanceSource {
  ...
  public LuminanceSource crop(int left, int top, int width, int height) {
    return new com.google.zxing.common.BufferedImageLuminanceSource(image, this.left + left, this.top + top, width, height);
  }
  ...
  public LuminanceSource rotateCounterClockwise() {
    ...
    int width = getWidth();
    return new com.google.zxing.common.BufferedImageLuminanceSource(rotatedImage, top, sourceWidth - (left + width), getHeight(), width);
  }
  ...
  public LuminanceSource rotateCounterClockwise45() {
    ...
    return new com.google.zxing.common.BufferedImageLuminanceSource(rotatedImage, newLeft, newTop, newRight - newLeft, newBottom - newTop);
  }
